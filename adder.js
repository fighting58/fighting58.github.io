...
* @param {number} canvasWidth - The width of the canvas where the fireworks effect will be displayed.
* @param {number} canvasHeight - The height of the canvas where the fireworks effect will be displayed.
*/
...
function setBackgroundImage() {
  ...
  const table = document.getElementById('puzzleTable');
  const tableBottom = table.offseTop + h1.offsetHeight;
  ...
  if (screenWidth > screenHeight) {
    ...
    body.style.backgroundPosition = `center bottom-{tableBottom}px`;
  }
}
